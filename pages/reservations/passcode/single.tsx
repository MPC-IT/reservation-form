// pages/reservations/passcode/single.tsx
...
export default function SingleDatePasscodePage() {
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      ...
      <h1 className="text-2xl font-bold mb-6">Single-Date Passcode Reservation</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="bg-white p-6 border border-gray-200 rounded-lg">
          <h2 className="text-lg font-bold mb-4">PASSCODE INVITATION DETAILS</h2>
          ...
          <div className="grid grid-cols-1 gap-4">
            ...
            <div>
              <label className="block text-sm font-medium mb-1">Passcode International Numbers</label>
        ...
        {/* HELPFUL HINTS */}
        <div className="bg-white p-6 border border-gray-200 rounded-lg">
          <h2 className="text-lg font-bold mb-4">HELPFUL HINTS</h2>
        ...
        <div className="bg-white p-6 border border-gray-200 rounded-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="md:col-span-2">
              ...
              <select name="bridgeInstructions" value={form.bridgeInstructions} onChange={handleChange} className="w-full border px-3 py-2 rounded">
