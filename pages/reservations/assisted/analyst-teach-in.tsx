// pages/reservations/assisted/analyst-teach-in.tsx
...
export default function AnalystTeachInPage() {
    ...
    try {
      const res = await fetch('/api/profiles/create', {
        ...
        body: JSON.stringify({
          ...
          replayParticipantListRecipientEmail: form.replayParticipantListRecipientEmail,
          other: form.other,
        }),
      });
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      ...
      <h1 className="text-2xl font-bold mb-6">Analyst Teach In Reservation</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        {/* ANALYST - FULLY MONITORED CONFERENCE CALL DETAILS */}
        <div className="bg-white p-6 border border-gray-200 rounded-lg">
          <h2 className="text-lg font-bold mb-4">ANALYST - FULLY MONITORED CONFERENCE CALL DETAILS</h2>
        ...
        {/* ANALYST SPEAKER INVITATION DETAILS */}
        <div className="bg-white p-6 border border-gray-200 rounded-lg">
        ...
        {/* ANALYST PARTICIPANT INVITATION DETAILS */}
        <div className="bg-white p-6 border border-gray-200 rounded-lg">
        ...
        <div className="bg-white p-6 border border-gray-200 rounded-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="md:col-span-2">
              <label className="block text-sm font-medium mb-1">Replay Participant List Recipient Email</label>
              <input type="email" name="replayParticipantListRecipientEmail" value={form.replayParticipantListRecipientEmail} onChange={handleChange} className="w-full border px-3 py-2 rounded" />
            </div>

            <div className="md:col-span-2">
              <label className="block text-sm font-medium mb-1">Other</label>
              <textarea name="other" value={form.other} onChange={handleChange} rows={3} className="w-full border px-3 py-2 rounded" />
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-6 border border-gray-200 rounded-lg">
          ...
          <div className="space-y-2 text-sm text-gray-700">
            <ul className="list-disc list-inside space-y-1">
              <li>Speaker Conference Dial In Numbers: Add Dedicated Dial In Number assigned to call details onto the bridge</li>
